...
--Query que consulta a relação entre blocos e atividades pelo ID da atividade

--SELECT B.ATIVIDADE_ID, B.FIM, B.INICIO, A.PRECO, A. DESCRICAO, A.NOME, A.ID  FROM TB_BLOCO B
